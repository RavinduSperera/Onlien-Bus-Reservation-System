    ...
    <section class = "register" id = "register">
        ...
        <div class = "row">
            ...
            <form action = "deleteReservation" method = "post"> 
            	...
            	<input type="text" name="reservationID" value = "<%=rid %>" class = "box" readonly> <br><br>
            	
            	<label>Bus Number </label><br>
            	<input type="text" name="bID" value = "<%=busName %>" class = "box" readonly> <br><br>
            	
            	<label>Destination </label><br>
            	<input type="text" name="to" value = "<%=destination %>" class = "box" readonly> <br><br>
            	
            	<label>No Of Seats </label><br>
            	<input type="text" name="sNo" value = "<%=seatNo %>" class = "box" readonly> <br><br>
            	</c:forEach>
            
            	<input type="submit" value="Cancel Reservation" class = "btn" name = "delete">
