...
<body>
	...
	<section class="register" id="register">
		<h1 class="heading">
			<span>Delete </span> Payment
		</h1>
		<div class="row">
			<form action="deletePayment" method="post">

				<legend>Delete Payment</legend>
				<br> <label for="account-number">Payment ID</label> 
				<input type="text" id="account-number" value="<%=paymentid%>"
					name="paymentid" readonly><br>
				<br> <label for="account-number">Reservation ID</label>
				 <input type="text" id="account-number" value="<%=reservationid%>"
					name="reservationid" readonly><br>
				<br> <label for="account-number">Account Number</label> <input
					type="text" id="account-number" value=" <%=accountnumber%>"
					name="accountnumber" readonly><br>
				<br> <label for="account-number">Payment Amount</label> <input
					type="text" id="account-number" value=" <%=paymentamount%>"
					name="paymentamount" readonly><br>
				<br>
				...
				<div class="left-input">
					...
					<div class="radio-option">
						<input type="text" id="account-number" 
							value="<%=paymentoption%>" name="paymentoption" readonly>
					</div>
				</div>
				<br>
				<br>
				<div class="right-input">
					<div class="input-box">
						<h3>Card Details</h3>
						<br> <input type="text" id="cardholder-name"
							value="<%=cardholder%>" name="cardholder" readonly>
					</div>
					<div class="input-box">
				...
				<br>
				<div class="input-box">
					<label>Expiry</label> <input type="text" id="expiry-date"
						value="<%=expdate%>" name="expdate" readonly>
				</div>

				<div class="input-box">
					<input type="tel" id="cvc" value="<%=cvc%>" name="cvc" readonly>
				</div>
				<input type="submit" name="submit" value="Cancel Payment" class="btn">
			</form>
