...
<body>
	...
	<header>
		...
		<nav class="navbar">
            ...
            <a href = "home.jsp#reservations">Reservations</a>
            <a href = "home.jsp#review">Review</a>
            <a href = "home.jsp#contact">Contact</a>
            <a href = "home.jsp#account">Account</a>
		</nav>
		
		<c:forEach var = "passenger" items= "${passengerDetails}">
			<c:set var = "pid" value = "${passenger.pid}"/>
			<c:set var = "fname" value = "${passenger.fname}"/>
			<c:set var = "lname" value = "${passenger.lname}"/>
			<c:set var = "age" value = "${passenger.age}"/>
			<c:set var = "city" value = "${passenger.city}"/>
			<c:set var = "pnumber" value = "${passenger.pnumber}"/>
			<c:set var = "email" value = "${passenger.email}"/>
			<c:set var = "username" value = "${passenger.username}"/>
			<c:set var = "password" value = "${passenger.pwd}"/>
			
    	<%
        	String city = (String)pageContext.getAttribute("city"); 
       	 	double priceGalle = 0.0;
        	double priceColombo = 0.0;
        	double priceMakubura = 0.0;
        	double priceKandy = 0.0;

        
        	if ("Galle".equals(city)) {
            	priceColombo = 1260.00;
            	priceKandy = 2000.00;
            	priceMakubura = 800.00;
        	} else if ("Colombo".equals(city)) {
            	priceGalle = 1260.00;
            	priceKandy = 600.00;
            	priceMakubura = 350.00;
        	} else if ("Kandy".equals(city)) {
            	priceGalle = 2000.00;
            	priceColombo = 600.00;
            	priceMakubura = 850.00;
        	} else if ("Makubura".equals(city)) {
            	priceGalle = 800.00;
            	priceColombo = 350.00;
            	priceKandy = 850.00;
        	}

        	request.setAttribute("priceGalle", priceGalle);
        	request.setAttribute("priceColombo", priceColombo);
        	request.setAttribute("priceMakubura", priceMakubura);
        	request.setAttribute("priceKandy", priceKandy);
    	%>
		</c:forEach>
		...
		<div class="icons">
			<c:url value = "passengerAccount.jsp" var = "passengerAccount">
    		...
    		<c:url value = "insertReservation.jsp" var = "insertReservation">
    			<c:param name="pid" value = "${pid}"/>
    			<c:param name="fname" value = "${fname}"/>
    			<c:param name="lname" value = "${lname}"/>
    			<c:param name="age" value = "${age}"/>
			...
			<a href="/reservation.html" class="fas fa-shopping-cart"></a> 
			<a href="${passengerAccount}" class="fas fa-user"> ${fname }</a>
		</div>
	...
	<section class="home" id="home"
		...
		<div class="content">
			...
			<br> <a href="${insertReservation}" class="btn">Book now</a>
		</div>
	</section>
	>
	<!--Home Section Ends-->
	...
	<section class="routes" id="reservations">
			...
			<c:url value = "insertReservation.jsp" var = "reserveBusKandy">
    			<c:param name="pid" value = "${pid}"/>
    			<c:param name="city" value = "${city}"/>
    			<c:param name="destination" value = "Kandy"/>
    		</c:url>
    		<c:url value = "insertReservation.jsp" var = "reserveBusGalle">
    			<c:param name="pid" value = "${pid}"/>
    			<c:param name="city" value = "${city}"/>
    			<c:param name="destination" value = "Galle"/>
    		</c:url>
    		<c:url value = "insertReservation.jsp" var = "reserveBusKaduwela">
    			<c:param name="pid" value = "${pid}"/>
    			<c:param name="city" value = "${city}"/>
    			<c:param name="destination" value = "Kaduwela"/>
    		</c:url>
    		<c:url value = "insertReservation.jsp" var = "reserveBusMakubura">
    			<c:param name="pid" value = "${pid}"/>
    			<c:param name="city" value = "${city}"/>
    			<c:param name="destination" value = "Makubura"/>
    		</c:url>
    		<c:url value = "insertReservation.jsp" var = "reserveBusColombo">
    			<c:param name="pid" value = "${pid}"/>
    			<c:param name="city" value = "${city}"/>
    			<c:param name="destination" value = "Colombo"/>
    		</c:url>
		...
		<div class="box-container">
			...
			<div class="box">
				...
				<div class="image">
					<img src="images/galleBusStand.jpg" alt="Galle Bus Stand">
					<div class="icons">
						<a href="${reserveBusGalle}" class="fas fa-heart"></a> <a href="${reserveBusGalle}" class="cart-btn">
							select route</a> <a href="${reserveBusGalle}" class="fas fa-share"></a>
					</div>
				</div>
				...
				<div class="content">
					...
					<div class="price">
						${requestScope.priceGalle}<span>Rs.990</span>
					</div>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="image">
					<img src="images/kandyBusStand.jpg" alt="Kandy Bus Stand">
					<div class="icons">
						<a href="${reserveBusKandy}" class="fas fa-heart"></a> <a href="${reserveBusKandy}" class="cart-btn">
							select route</a> <a href="${reserveBusKandy}" class="fas fa-share"></a>
					</div>
				</div>
				...
				<div class="content">
					...
					<div class="price">
						${requestScope.priceKandy}<span>Rs.990</span>
					</div>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="image">
					<img src="images/makuburaBusStand.jpg" alt="Makubura Bus Stand">
					<div class="icons">
						<a href="${reserveBusMakubura}" class="fas fa-heart"></a> <a href="${reserveBusMakubura}" class="cart-btn">
							select route</a> <a href="${reserveBusMakubura}" class="fas fa-share"></a>
					</div>
				</div>
				...
				<div class="content">
					...
					<div class="price">
						${requestScope.priceMakubura}<span>Rs.990</span>
					</div>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="image">
					<img src="images/colomboBusStand.jpg" alt="Colombo Bus Stand">
					<div class="icons">
						<a href="${reserveBusColombo}" class="fas fa-heart"></a> <a href="${reserveBusColombo}" class="cart-btn">
							select route</a> <a href="${reserveBusColombo}" class="fas fa-share"></a>
					</div>
				</div>
				...
				<div class="content">
					...
					<div class="price">
						${requestScope.priceColombo}<span>Rs.990</span>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="contact" id="account">
		

		<h1 class="heading">
			<span>Passenger</span> Account
		</h1>
		<div class="row">
			<form>
				<table>
				...
				<c:url value="updatePassenger.jsp" var="updatePassenger">
					<c:param name="pid" value="${pid}" />
					<c:param name="fname" value="${fname}" />
					<c:param name="lname" value="${lname}" />
					<c:param name="pnumber" value="${pnumber}" />
				...
				<c:url value="deletePassenger.jsp" var="deletePassenger">
					<c:param name="pid" value="${pid}" />
					<c:param name="fname" value="${fname}" />
					<c:param name="lname" value="${lname}" />
					<c:param name="pnumber" value="${pnumber}" />
    			...
    			<span class = "paymentDelete">
    				<a href = "${deletePassenger}">
    					<input type = "button" name = "delete" value = "Remove Account" class = "btn">
    				</a>
    	
    	
    				<a href = "${updatePassenger}">
    					<input type = "button" name = "update" value = "Update Account" class = "btn">
    				</a>
    			</span>
