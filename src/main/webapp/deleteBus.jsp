...
<body>
    ...
    <section class = "register" id = "register">
        <h1 class = "heading"><span>Delete </span> Bus</h1>
        <div class = "row">

            <form action = "busdelete" method = "post"> 

                <legend>Delete Bus details </legend><br><br>
				
				<label>Bus ID:</label><br>
				<input type = "text"  class = "box" name = "busID" value="<%=busID%>" readonly><br>

                <label>Bus Number:</label><br>
                <input type = "text"  class = "box" name = "busNumber" value="<%=busnumber%>" readonly>
                <br>
                  <label>Bus Type:</label>
                <input list = "busType" class = "box" name = "busType" value="<%=bustype%>" readonly>
                ...
                <input type = "text" class = "box" name = "driverName" value="<%=fname%>" readonly><br>
                
                <label>Total Seats:</label>
                <input type = "text" class = "box" name = "totalSeats" value="<%=totalSeats%>" readonly> <br>
                
                <label>Available Seats:</label>
                <input type = "text" class = "box"  name = "availableSeats" value="<%=availableSeats%>" readonly> <br>
                
                <input type = "submit" value="Delete Bus" class = "btn">
